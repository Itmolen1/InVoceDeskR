...
namespace InvoiceDiskLast.Controllers
{
    ...
    public class MvcInvoiceServicesController : Controller
    {
        ...
        public JsonResult GetAllServiceList()
        {
            ...
            try
            {
                ...
                HttpResponseMessage response = GlobalVeriables.WebApiClient.GetAsync("GetPurchaseInvoiceList/" + StatusEnum.Services + "/" + companyId).Result;
        ...
        public ActionResult AddOrEdit(int id)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    HttpResponseMessage responsep = GlobalVeriables.WebApiClient.GetAsync("APIProduct/" + CompanyID + "/" + Status).Result;
        ...
        public ActionResult OrderSirviceList()
        {
            return View();
        }
